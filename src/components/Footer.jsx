...
export default function Footer() {
  ...
  return (
    <footer className="bg-background border-t border-white/5">
      <div className="max-w-7xl mx-auto py-12 px-6 md:px-8 flex flex-col md:flex-row justify-between items-center gap-8">
        {/* Brand */}
        <div className="flex flex-col items-center md:items-start gap-2">
          <span className="text-xl font-extrabold gradient-text font-headline">Vexxo Studio</span>
          <p className="text-on-surface-variant text-xs">{t("footer.copy")}</p>
        </div>
